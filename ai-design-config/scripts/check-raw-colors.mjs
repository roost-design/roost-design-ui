...
const ALLOW_LINE = /var\s*\(\s*--rd-|color-mix\s*\(|transparent|currentColor|inherit|none/
...
if (violations.length) {
  console.error(`Found ${violations.length} raw color literal(s). Use --rd-* tokens instead:\n`)
