...
import { WkIcon, WkScrollbar } from '@wise-kit/ui'
...
<template>
  <div class="mobile-sidebar-shell">
    ...
    >
      <WkScrollbar :class="scrollClass ?? 'mobile-sidebar-shell__scroll'">
        <div
          :class="bodyClass"
          @click="onPanelClick"
        >
...
.mobile-sidebar-shell__panel > :deep(.wk-scrollbar),
...
.mobile-sidebar-shell__panel > :deep(.wk-scrollbar .wk-scrollbar__wrap) {
...
.mobile-sidebar-shell__scroll :deep(.wk-scrollbar__wrap) {
  overscroll-behavior: contain;
}
...
@media (max-width: 700px) {
  ...
  .mobile-sidebar-shell__panel {
    background: color-mix(in srgb, var(--wk-color-surface) 96%, transparent);
    ...
    transition: transform var(--wk-motion-normal) var(--wk-motion-ease);
