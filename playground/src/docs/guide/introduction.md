...
title: 介绍
order: 1
description: Wise Kit UI 是什么、适合谁用、如何开始。
---

# 介绍

**Wise Kit UI**（`@wise-kit/ui`）是一套**开源**的 Vue 3 组件库，内置设计令牌、亮暗主题、国际化与交互式文档。

- **文档站**：[wise-kit.github.io/wise-kit-ui](https://wise-kit.github.io/wise-kit-ui/)
- **源码**：[GitHub](https://github.com/wise-kit/wise-kit-ui)
...
| 包 | 说明 |
| --- | --- |
| `@wise-kit/ui` | 组件、样式、主题 API、文档站源码 |
| `@wise-kit/ui-mcp` | （可选）MCP 服务，供支持该协议的 AI 客户端检索文档 |
...
- [设计令牌](/docs/design-tokens)：全部 `--wk-*` 变量与用途
- [全局配置](/docs/config)：`ConfigProvider` / `createWiseKit`
- [无障碍](/docs/accessibility)：键盘、表单与浮层约定
- [组件](/components)：浏览全部组件与 API
- [参与贡献](https://github.com/wise-kit/wise-kit-ui/blob/main/CONTRIBUTING.zh-CN.md)
