...
title: 介绍
order: 1
description: Roost Design UI 是什么、适合谁用、如何开始。
---
...
| **按需加载** | ESM 子路径 + `RoostDesignResolver`，支持 tree-shaking |
...
| 包 | 说明 |
| --- | --- |
| `@roost-design/ui` | 组件、样式、主题 API、文档站源码 |
| `@roost-design/ui-mcp` | （可选）MCP 服务，供支持该协议的 AI 客户端检索文档 |
...
- [全局配置](/docs/config)：`ConfigProvider` / `createRoostDesign`
- [无障碍](/docs/accessibility)：键盘、表单与浮层约定
- [组件](/components)：浏览全部组件与 API
- [参与贡献](https://github.com/roost-design/roost-design-ui/blob/main/CONTRIBUTING.zh-CN.md)
