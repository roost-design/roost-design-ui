      ...
      <section class="home-hero">
        ...
        <div class="home-actions">
          <RouterLink :to="{ name: 'docs', params: { slug: 'quick-start' } }">
            <RdButton :label="t.start" />
          </RouterLink>
          <RouterLink :to="{ name: 'components' }">
            <RdButton :label="t.browse" outlined />
          </RouterLink>
          <a :href="SITE_GITHUB_URL" target="_blank" rel="noopener noreferrer">
            <RdButton :label="t.viewGithub" outlined />
          </a>
        </div>
...
.home-hero {
  animation: home-rise 0.7s var(--rd-motion-ease) both;
  max-width: 46rem;
  position: relative;
}
...
.home-brand {
  background: linear-gradient(
    120deg,
    var(--rd-color-text) 10%,
    color-mix(in srgb, var(--rd-color-primary) 75%, #22d3ee) 55%,
    var(--rd-color-primary) 100%
  );
...
.home-meta span {
  background: color-mix(in srgb, var(--rd-color-surface) 65%, transparent);
...
.home-install {
  animation: home-rise 0.75s var(--rd-motion-ease) both;
...
.home-install__cmd {
  align-items: center;
  background: color-mix(in srgb, var(--rd-color-text) 4%, var(--rd-color-surface));
  border: 1px solid var(--docs-edge);
...
.home-install__copy {
  ...
  border: 1px solid color-mix(in srgb, var(--rd-color-primary) 28%, transparent);
...
.home-pillar {
  animation: home-rise 0.8s var(--rd-motion-ease) both;
...
.home-pillar::before {
  background: linear-gradient(120deg, transparent, color-mix(in srgb, var(--rd-color-primary) 35%, transparent));
  content: '';
  height: 1px;
  left: 0;
  position: absolute;
