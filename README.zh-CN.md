...
<p align="center">
  <a href="https://roost-design.github.io/roost-design-ui/"><b>文档站</b></a>
  ·
  <a href="https://roost-design.github.io/roost-design-ui/components">组件</a>
  ·
...
兼容 **Nuxt 3**、**Astro + Vue**、**Vite SSR** 等场景；提供 [`@roost-design/nuxt`](./packages/nuxt) 模块，详见 [SSR 指南](https://roost-design.github.io/roost-design-ui/docs/ssr)。
...
| 章节 | 链接 |
| --- | --- |
| 快速上手 | [指南](https://roost-design.github.io/roost-design-ui/docs/quick-start) |
| 主题 | [主题](https://roost-design.github.io/roost-design-ui/docs/theme) |
| 全局配置 | [配置](https://roost-design.github.io/roost-design-ui/docs/config) |
| SSR | [Nuxt / Astro / Vite SSR](https://roost-design.github.io/roost-design-ui/docs/ssr) |
| 组件 | [目录](https://roost-design.github.io/roost-design-ui/components) |
| 更新日志 | [版本](https://roost-design.github.io/roost-design-ui/changelog) |
...
createApp(App).use(createRoostDesign({ locale: zhCN })).mount('#app')
```

完整接入方式、Vite 解析器与主题 API 见 [快速上手](https://roost-design.github.io/roost-design-ui/docs/quick-start)。

## 生态

| 包 | 说明 |
| --- | --- |
| [`@roost-design/ui`](https://www.npmjs.com/package/@roost-design/ui) | 组件、样式、主题与语言工具 |
| [`@roost-design/nuxt`](./packages/nuxt) | Nuxt 3 模块（样式、transpile、overlay 上下文） |
| [`@roost-design/ui-mcp`](https://www.npmjs.com/package/@roost-design/ui-mcp) | 可选 MCP 服务，供 AI 客户端检索文档 |
