...
export type RdRouteLocationRaw = string | Record<string, unknown>
...
export function resolveRouteHref(to: RdRouteLocationRaw): string {
...
export function isExternalRoute(to: RdRouteLocationRaw): boolean {
  if (typeof to === 'string') {
