...
export interface RdGridContext {
...
export const RD_GRID_KEY: InjectionKey<RdGridContext> = Symbol('rdGrid')
export const RD_GRID_ITEM_FLAG = '__WI_GRID_ITEM__' as const
