...
**Unlike Dropdown:** `RdSelect` is a form control. Use `RdDropdown` for action menus.
...
<template>
  <div style="display:grid;gap:1rem;width:min(24rem,100%)">
    <RdSelect v-model="value" :options="[]" empty-message="No options" placeholder="Empty list" />
