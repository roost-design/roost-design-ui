...
<template>
    ...
    >
        ...
        <Teleport :to="teleportTarget.to" :disabled="teleportTarget.disabled">
            <Transition name="rd-popover">
                <div
                    v-if="modelValue"
                    ref="panel"
                    :id="panelId"
                    class="rd-popover__content"
                    :class="[
                        `rd-popover__content--${placement}`,
                        { 'rd-popover__content--teleported': teleported },
                    ]"
