...
<template>
  <div class="wk-treetable">
    <table class="wk-treetable__table" role="treegrid">
      <thead>
        <tr>
    ...
    <div v-if="!value.length" class="wk-treetable__message" role="status">
      <slot name="empty">
        <p class="wk-treetable__empty-text">{{ resolvedEmptyMessage }}</p>
      </slot>
    </div>
  </div>
</template>
