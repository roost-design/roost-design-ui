...
export interface LayoutProps {
  /** Layout height. Defaults to `var(--wk-layout-height)`. */
...
export interface LayoutHeaderProps {
  /** Header height. Defaults to `var(--wk-layout-header-height)`. */
  height?: number | string;
...
export interface LayoutFooterProps {
  /** Footer height. Defaults to `var(--wk-layout-footer-height)`. */
  height?: number | string;
  padding?: number | string;
  radius?: number | string;
  bordered?: boolean;
