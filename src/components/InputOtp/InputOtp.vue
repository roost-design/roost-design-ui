...
const rootClass = computed(() => [
  'rd-inputotp',
  `rd-inputotp--${sizeClass.value}`,
  {
    'rd-inputotp--disabled': props.disabled,
    'rd-inputotp--mask': props.mask,
    'rd-inputotp--invalid': props.invalid,
  },
])
