...
<template>
  <div
    ref="root"
    class="rd-splitter"
    :style="{ '--rd-splitter-trigger-size': `${resizeTriggerSize}px` }"
    :class="[
      `rd-splitter--${resolvedLayout}`,
      {
        'rd-splitter--dragging': dragging,
        'rd-splitter--disabled': disabled,
      },
    ]"
    :aria-orientation="isVertical ? 'vertical' : 'horizontal'"
  >
    <div class="rd-splitter__panel" :class="pane1Class" :style="panel1Style">
    ...
    <div class="rd-splitter__panel rd-splitter__panel--fill" :class="pane2Class" :style="panel2Style">
