...
<template>
  <RdAutoComplete v-model="value" :suggestions="suggestions" dropdown placeholder="搜索…" />
</template>
```
...
<template>
  <RdAutoComplete v-model="value" :suggestions="suggestions" clearable placeholder="选项对象…" />
</template>
```
