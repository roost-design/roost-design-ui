...
感谢你对 Wise Kit UI 的关注！

## 贡献方式

- **报告 Bug** — 在 [Issues](https://github.com/wise-kit/wise-kit-ui/issues) 中提供复现步骤。
...
1. 阅读 [在线文档](https://wise-kit.github.io/wise-kit-ui/)。
...
如果不确定改动是否合适，请先 [提 Issue](https://github.com/wise-kit/wise-kit-ui/issues) 讨论，避免在大改动上白费功夫。
