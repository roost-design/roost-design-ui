...
Works with **Nuxt 3**, **Astro + Vue**, **Vite SSR**, and similar setups. Includes the [`@morya-space/nuxt`](./packages/nuxt) module — see the [SSR guide](https://morya-ui.github.io/morya-ui/docs/ssr).
...
| [`@morya-space/nuxt`](./packages/nuxt) | Nuxt 3 module (styles, transpile, overlay context) |
